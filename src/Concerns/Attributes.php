...
trait Attributes
{
    ...
    protected function getAttributes(string|null $attributeClass = null): array
    {
    ...
    protected static function getEnumAttributes(string|null $attributeClass = null): array
    {
