...
trait Reporters
{
    ...
    public static function getOrReport(int|string|null $key, BackedEnum|null $context = null): ?self
    {
        return EnumReporter::getOrReport(self::class, $key, $context, self::reporter());
    }

    public static function getOrReportArray(iterable $keys, BackedEnum|null $context = null): array
    {
